...
<head>
    ...
    <style>
        ...
        .container {
            ...
            padding: 5px;
            margin: 0 auto;
            border: 1px solid #ccc; /* Optional border around the ticket */
            display: flex;
            flex-direction: column;
            justify-content: flex-start;
            align-items: flex-start; /* Left-align content inside container */
        }
        ...
        /* Adjustments for QR Code */
        .qr-section {
            display: flex;
            justify-content: center; /* Center align QR code */
            width: 100%;
            margin-top: 20px;
        }

        .ticket-summary p {
            text-align: left; /* Left align the ticket details */
            margin: 2px 0;
        }
    </style>
</head>
...
<body>
    <div class="ticket-container">
        ...
        <div class="container">
            <!-- Ticket details aligned vertically -->
            <div class="ticket-summary border-bottom">
                ...
                <!-- Fare price at the bottom -->
                {{--<p class="border-top">
                    {{ __('fare_price') }}:{{ $booking->trainSchedule->fare_price }}
                </p>--}}
            </div>

            <!-- QR Code aligned to the center -->
        ...
        <div style="margin-top: 20px; text-align: center;">
            {{ config('site_settings.rights_reserved_content') }}
        </div>

        <div class="no-print" id="print-btn" style="margin-top: 20px; text-align: center;">
